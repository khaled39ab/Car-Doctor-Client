...
const Contact = () => {
    return (
        <div className="bg-black text-white flex justify-around p-20 rounded-lg">
            <div className="flex">
                <div className="h-12 mr-3">
                    <svg className='h-full' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
